...
class _Theme:
    def __init__(self):
        ...
        self.LIGHT_TOKENS = {
            ...
            "white": "#ffffff",
            "window_bg": "#ffffff",
            "text_primary": "#1f2937",  # c_neutral_800
            "text_secondary": "#4b5563",  # c_neutral_600
            "border_color": "#e5e7eb",  # c_neutral_200
            "input_bg": "#ffffff",
            "panel_bg": "#f9fafb",  # c_neutral_50
            # Primary Brand Colors (Blue)
            "c_primary_50": "#eff6ff",
            "c_primary_100": "#dbeafe",
            "c_primary_200": "#bfdbfe",
            "c_primary_300": "#93c5fd",
            "c_primary_500": "#3b82f6",
            "c_primary_600": "#2563eb",
            "c_primary_700": "#1d4ed8",
            "c_primary_800": "#1e40af",
            # Neutrals
            "c_neutral_50": "#f9fafb",
            "c_neutral_100": "#f3f4f6",
            "c_neutral_200": "#e5e7eb",
            "c_neutral_300": "#d1d5db",
            "c_neutral_400": "#9ca3af",
            "c_neutral_500": "#6b7280",
            "c_neutral_600": "#4b5563",
            "c_neutral_700": "#374151",
            "c_neutral_800": "#1f2937",
            # Status
            "c_success": "#10b981",
            "c_success_light": "#d1fae5",
            "c_error": "#ef4444",
            "c_error_light": "#fee2e2",
            "c_warning": "#f59e0b",
        ...
        self.DARK_TOKENS = self.LIGHT_TOKENS.copy()
        self.DARK_TOKENS.update(
            {
                # Inverted Backgrounds & Text
                "white": "#1e1e1e",  # Dark Grey Background
                "window_bg": "#121212",  # Almost black
                "text_primary": "#e5e7eb",  # Light Grey Text
                "text_secondary": "#9ca3af",  # Dimmer Text
                "border_color": "#374151",  # Dark Border
                "input_bg": "#2d2d2d",  # Input fields
                "panel_bg": "#1f1f1f",
                # Neutrals (Inverted logic for Dark Mode)
                "c_neutral_50": "#1f1f1f",
                "c_neutral_100": "#262626",
                "c_neutral_200": "#374151",
                "c_neutral_300": "#4b5563",
                "c_neutral_800": "#f3f4f6",  # Used for high contrast text
                "c_neutral_700": "#e5e7eb",
                "c_neutral_600": "#d1d5db",
                "c_neutral_500": "#9ca3af",
                # Adjust badges for dark mode (darker backgrounds, lighter text)
                "c_success_light": "#064e3b",
                "badge_success_text": "#a7f3d0",
                "c_warning_light": "#78350f",
                "badge_warning_text": "#fde68a",
                "c_error_light": "#7f1d1d",
                "badge_error_text": "#fecaca",
            }
        )

        # Start in Light Mode
        self.TOKENS = self.LIGHT_TOKENS

    def set_dark_mode(self, is_dark: bool):
        """Switches the token set and returns the new tokens."""
        self.TOKENS = self.DARK_TOKENS if is_dark else self.LIGHT_TOKENS
...
# These functions generate the stylesheet ON DEMAND based on current mode
def get_app_stylesheet():
    return _theme._generate(_APP_STYLESHEET_TEMPLATE)


def get_camera_style():
    return _theme._generate(_CAMERA_PANEL_STYLE_TEMPLATE)


def get_ct400_style():
    return _theme._generate(_CT400_CONTROL_PANEL_STYLE_TEMPLATE)


# Initial load
APP_STYLESHEET = get_app_stylesheet()
CAMERA_PANEL_STYLE = get_camera_style()
CT400_CONTROL_PANEL_STYLE = get_ct400_style()
